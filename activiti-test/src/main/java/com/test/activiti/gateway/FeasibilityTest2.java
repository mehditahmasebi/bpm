...
public class FeasibilityTest2 extends BaseTest {
	
	public static final String KEY = "FeasibilityKEY2";
	Logger logger = Logger.getLogger(FeasibilityTest2.class);

	@Override
	protected String[] getBpmnFiles() {
		return new String[] {"com/test/activiti/gateway/Feasibility2.bpmn"};
	}
