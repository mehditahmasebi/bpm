...
public class FlowConditionTest2 extends BaseTest {

	public static final String KEY = "FlowCondition2";
	Logger logger = Logger.getLogger(FlowConditionTest2.class);
	
	@Override
	protected String[] getBpmnFiles() {
		return new String[] {"com/test/activiti/flowcondition/FlowCondition2.bpmn"};
	}
